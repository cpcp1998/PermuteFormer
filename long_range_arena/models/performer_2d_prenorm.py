...
_CONFIG_FOR_DOC = "PerformerConfig"
...
class BertSelfAttention(nn.Module):
    ...
    def expand_permutation(self, permutation, prefix, postfix, width, height):
...
BERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers.PerformerConfig`): Model configuration class with all the parameters of the model.
